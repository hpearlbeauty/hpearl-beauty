  ...
  return (
    <div className="bg-ink text-ivory">
      <div className="container-editorial flex h-[72px] items-center justify-between">
        <Link href="/" className="text-[18px] font-semibold tracking-tight">hpearl_beauty</Link>
        <p className="t-label text-champagne">Booking <span aria-hidden="true" className="mx-2">•</span> {label}</p>
      </div>
