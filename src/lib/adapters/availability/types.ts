...
export interface AvailabilityProvider {
  ...
  getAvailableDates(serviceId: ServiceId, month: string, schedule?: string): Promise<string[]>;
  getSlots(serviceId: ServiceId, date: string, schedule?: string): Promise<Slot[]>;
